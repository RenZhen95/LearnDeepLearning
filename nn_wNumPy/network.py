...
class Network(object):
    ...
    def update_mini_batch(self, mini_batch, lr):
        ...
        biases.
        """
        # Initializing the gradient vectors for biases and weights
        nabla_b = [np.zeros(b.shape) for b in self.biases]
        nabla_w = [np.zeros(w.shape) for w in self.weights]

        for x, y in mini_batch:
            # Invoke backpropagation algorithm to compute gradient of
            # cost function
...
def sigmoid(z):
    ...
    If z is a Numpy array, Numpy automatically applies the function
    elementwise.
    """
